...
export const createProjectImageAsset = (image = {}, pageId = null) => {
  ...
  return {
    ...
    sceneSpec: image.sceneSpec && typeof image.sceneSpec === 'object' ? image.sceneSpec : null,
    generationPolicy: image.generationPolicy && typeof image.generationPolicy === 'object' ? image.generationPolicy : null,
  ...
  for (const page of project.pages) {
    if (page.imageUrl || page.imageLocalPath || page.illustration?.url || page.illustration?.localPath) {
      images.push(normalizeImageEntry({
        ...
        sceneSpec: page.generationMeta?.sceneSpec,
        generationPolicy: page.generationMeta?.generationPolicy,
